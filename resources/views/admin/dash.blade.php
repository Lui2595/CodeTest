        ...
        <div class="row text-center">
          <div class="card col-md-6 col-lg-3" >
            <div class="card-body">
              ...
              <h2 class="card-text  text-center">{{$admins}}</h2>
            </div>
          </div>
          <div class="card col-md-6 col-lg-3" >
            <div class="card-body">
              <h5 class="card-title text-center">Supervisors Users</h5>
              <h2 class="card-text  text-center">{{$supervisors}}</h2>
            </div>
          </div>
          <div class="card col-md-6 col-lg-3" >
            <div class="card-body">
              <h5 class="card-title text-center">Bloggers Users</h5>
              <h2 class="card-text  text-center">{{$bloggers}}</h2>
            </div>
          </div>
        </div>
        <br>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('admin.dash')}}" method="POST">
                @csrf
                @method("PUT")
                <div class="col-12">
                  <div class="form-row">
