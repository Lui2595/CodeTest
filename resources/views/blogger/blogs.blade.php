        ...
        <div class="modal-dialog modal-dialog-post" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('blogger.blogsAdd')}}" method="POST" id="addform">
                @csrf
                <div class="col-12">
            ...
            <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="updateLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-post" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="{{route('blogger.blogsUpdate')}}" method="POST" id="updateform">
                      @csrf
                      @method("PUT")
                      <div class="col-12">
        ...
        <div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-labelledby="delete_modalLabel" aria-hidden="true">
          <div class="modal-dialog " role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="{{route('blogger.blogsDelete')}}" method="POST" id="delete_form" >
                  @csrf
                  @method("DELETE")
                  <div class="col-12">
